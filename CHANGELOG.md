...
*  [BUGFIX][GSD-360] Add 'calendar' php extension to php8.1 pipeline image *(Matthijs Breed)*
*  [FEATURE][IN23-375] Created Warden image with open telemetry *(René Schep)*
*  [FEATURE][DBD-11] Higher node version for tailwind *(Fabian Bank)*
*  [FEATURE][DBD-11] Use node version 18 for tailwind *(Fabian Bank)*
*  Update Dockerfile *(dylanmaurits)*
*  [FEATURE][F24-98] Add node 18 versions for php 8.2/8.3/8.4 *(Matthijs Breed)*
*  [FEATURE][BOX-4] add ext-ftp to php extensions *(Simon Vianen)*
*  [FEATURE][BOX-4] Fix php extension name *(Matthijs Breed)*
*  [FEATURE][SPC-5121] Add php 8.2 node 16 image *(Jordy Pouw)*
*  [FEATURE][GSD-747] Updated image builds, old dependencies were no longer supported by newer debian version *(Matthijs Breed)*
*  [FEATURE][GSD-747] Add python setuptools to fix error npm ERR! ModuleNotFoundError: No module named 'distutils' *(Matthijs Breed)*
*  [FEATURE][DBD-207] Fix php 8.3 node 18 build file *(Matthijs Breed)*
